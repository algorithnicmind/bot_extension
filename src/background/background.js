importScripts("https://cdnjs.cloudflare.com/ajax/libs/marked/4.3.0/marked.min.js");
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    ...
    if (request.action === 'askAI') {
        ...
        chrome.storage.local.get(['apiKey', 'provider'], function(result) {
            ...
            if (!result.apiKey) {
                sendResponse({ error: 'API key not found. Please set your key in the extension options.' });
                return;
            }
